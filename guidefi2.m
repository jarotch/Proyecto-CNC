...
colorBoton = [0.4, 0.4, 0.9]; % Azul claro
colorBotonSeleccionado = [0.3, 0.3, 0.8]; % Azul medio
...
colorBotonGuiaUsuario = [0.9, 0.6, 0.6]; % Rosado para el botÃ³n "GuÃ­a de Usuario"
...
btnEjecutar = uicontrol(panelPrincipal, 'Style', 'pushbutton', 'String', 'Ejecutar G-code', 'Position', [450, 180, 180, 30], 'Callback', @ejecutarGcode, 'BackgroundColor', colorBotonEjecutarGcode, 'FontSize', 12);
...
btnListaDeComandos = uicontrol(panelPrincipal, 'Style', 'pushbutton', 'String', 'Lista de comandos', 'Position', [450, 300, 180, 30], 'Callback', @mostrarListaDeComandos, 'BackgroundColor', colorBotonListaComandos, 'FontSize', 12);

% Crear un botÃ³n "GuÃ­a de Usuario" para abrir un archivo PDF
btnGuiaUsuario = uicontrol(panelPrincipal, 'Style', 'pushbutton', 'String', 'Guía de Usuario', 'Position', [450, 360, 180, 30], 'Callback', @abrirGuiaUsuario, 'BackgroundColor', colorBotonGuiaUsuario, 'FontSize', 12);
    ...
    btnDesplazamientoLento = uicontrol(panelPrincipal, 'Style', 'pushbutton', 'String', 'Desplazamiento Lento', 'Position', [450, 410, 180, 35], 'Callback', @abrirVentanEmergente, 'BackgroundColor', colorBoton, 'FontSize', 12);

    % Realizar un muestreo
    btnMuestra = uicontrol(panelPrincipal, 'Style', 'pushbutton', 'String', 'Muestrear', 'Position', [450, 20, 180, 30],'Callback', @abrirMuestreo, 'BackgroundColor',colorBoton, 'FontSize', 12);
...
function abrirMuestreo(~, ~)
        ...
        btnMuestreo_Y = uicontrol(figVentana, 'Style', 'pushbutton', 'String', 'Muestrear en Y', 'Position', [62, 110, 180, 30], 'Callback', @ejecutarGcodeMuestra_X, 'BackgroundColor',  [0.01 0.67 0.45], 'FontSize', 14, 'ForegroundColor', [1, 1, 1]);
        ...
        uicontrol(figVentana, 'Style', 'text', 'String', 'Longitud:', 'Position', [95, 50, 70, 20], 'BackgroundColor', [0.01 0.67 0.45], 'FontSize', 13, 'ForegroundColor', [1, 1, 1]);
        ...
        uicontrol(figVentana, 'Style', 'text', 'String', 'Tiempo:', 'Position', [95, 20, 70, 20], 'BackgroundColor',  [0.01 0.67 0.45], 'FontSize', 13, 'ForegroundColor', [1, 1, 1]);
    ...
    function abrirVentanaEmergente(~, ~)
        ...
        btnArriba = uicontrol(figEmergente, 'Style', 'pushbutton', 'String', 'â†‘', 'Position', [120, 155, 50, 30], 'Callback', @ejecutarGcodeArriba, 'BackgroundColor', [0.4, 0.7, 0.9], 'FontSize', 14, 'ForegroundColor', [1, 1, 1]);
        btnAbajo = uicontrol(figEmergente, 'Style', 'pushbutton', 'String', 'â†“', 'Position', [120, 85, 50, 30], 'Callback', @ejecutarGcodeAbajo, 'BackgroundColor', [0.4, 0.7, 0.9], 'FontSize', 14, 'ForegroundColor', [1, 1, 1]);
        btnIzquierda = uicontrol(figEmergente, 'Style', 'pushbutton', 'String', 'â†?', 'Position', [70, 120, 50, 30], 'Callback', @ejecutarGcodeIzquierda, 'BackgroundColor', [0.4, 0.7, 0.9], 'FontSize', 14, 'ForegroundColor', [1, 1, 1]);
        btnDerecha = uicontrol(figEmergente, 'Style', 'pushbutton', 'String', 'â†’', 'Position', [170, 120, 50, 30], 'Callback', @ejecutarGcodeDerecha, 'BackgroundColor', [0.4, 0.7, 0.9], 'FontSize', 14, 'ForegroundColor', [1, 1, 1]);
    ...
    function abrirVentanEmergente(~, ~)
        ...
        % Agregar botones para las flechas con colores personalizados
        btnArriba = uicontrol(figEmergente, 'Style', 'pushbutton', 'String', 'â†‘', 'Position', [120, 150, 50, 30], 'Callback', @ejecutarGcodeArriba, 'BackgroundColor', [0.4, 0.7, 0.9], 'FontSize', 14, 'ForegroundColor', [1, 1, 1]);
        btnAbajo = uicontrol(figEmergente, 'Style', 'pushbutton', 'String', 'â†“', 'Position', [120, 90, 50, 30], 'Callback', @ejecutarGcodeAbajo, 'BackgroundColor', [0.4, 0.7, 0.9], 'FontSize', 14, 'ForegroundColor', [1, 1, 1]);
        btnIzquierda = uicontrol(figEmergente, 'Style', 'pushbutton', 'String', 'â†?', 'Position', [70, 120, 50, 30], 'Callback', @ejecutarGcodeIzquierda, 'BackgroundColor', [0.4, 0.7, 0.9], 'FontSize', 14, 'ForegroundColor', [1, 1, 1]);
        btnDerecha = uicontrol(figEmergente, 'Style', 'pushbutton', 'String', 'â†’', 'Position', [170, 120, 50, 30], 'Callback', @ejecutarGcodeDerecha, 'BackgroundColor', [0.4, 0.7, 0.9], 'FontSize', 14, 'ForegroundColor', [1, 1, 1]);
...
function GUIEnglish()
    ...
    btnDesplazamientoLento = uicontrol(mainPanel, 'Style', 'pushbutton', 'String', 'Slow Move', 'Position', [450, 410, 150, 35], 'Callback', @abrirVentanEmergente, 'BackgroundColor', buttonColor, 'FontSize', 13);
     ...
     % Realizar un muestreo
    btnMuestra = uicontrol(mainPanel, 'Style', 'pushbutton', 'String', 'Sampling', 'Position', [450, 20, 180, 30],'Callback', @abrirMuestreo, 'BackgroundColor',buttonColor, 'FontSize', 12);
...
function abrirMuestreo(~, ~)
    ...
    function ejecutarGcodeMuestra_X(~, ~)
            ...
            tiempo = str2double(get(editTiempo, 'String'));
            if isnan(Longitud) || isnan(tiempo)
                msgbox('Enter valid values ​​for length and time.', 'Error', 'error');
                return;
            end
